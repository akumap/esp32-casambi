 ...
 *
 * GET / serves the human-facing status dashboard (dashboard.h): a static page
 * that reads the same /api/* + /ws interface from the browser — it is a
 * CLIENT of the interface below, not part of it.
 *
